    ...
    <section id="hero" className="flex items-center bg-white dark:bg-gray-900 min-h-[calc(100dvh-73px)]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                <a href="/resume.pdf" download="서승준_이력서.pdf" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    이력서 다운로드
