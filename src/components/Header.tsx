        ...
        <header className="max-w-screen-xl flex flex-wrap items-center justify-between gap-8 mx-auto p-4 bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-50 border-b">
            ...
            <nav className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div
                    ...
                    id="navbar-nav"
                >
                    <ul className="flex flex-col justify-center p-4 md:p-0 font-medium border border-gray-100 rounded-lg bg-gray-50 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
