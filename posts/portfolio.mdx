...
- \*_lib/posts.ts
  export async function getAllPostsMeta() { /_ index.mdx 제외 필터 _/ }
  export async function getPostBySlug(slug: string) { /_ MDX 직렬화 \*/ }

- \*_블로그 리스트 (pages/blog/index.tsx)
  import { MDXRemote } from 'next-mdx-remote'
  export default function BlogIndex({ indexSource, posts }) { /_ MDX intro + 목록 \*/ }
...
- \*\*Tailwind Typography: <main className="prose prose-lg dark:prose-invert">

- \*\*ARIA 속성: aria-label, aria-expanded, aria-controls, aria-modal

- \*\*키보드 내비게이션: tabIndex, onKeyDown, focus:ring
